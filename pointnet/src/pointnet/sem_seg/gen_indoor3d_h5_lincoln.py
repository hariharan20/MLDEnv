...
indoor3d_data_dir = os.path.join(data_dir, 'lincoln_indoor3d')
NUM_POINT = 4096
H5_BATCH_SIZE = 1000
...
# Set paths
filelist = os.path.join(BASE_DIR, 'metal/all_data_label.txt')
data_label_files = [os.path.join(indoor3d_data_dir, line.rstrip()) for line in open(filelist)]
output_dir = os.path.join(data_dir, 'indoor3d_sem_seg_hdf5_data_lincoln')

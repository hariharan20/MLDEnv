...
class cp(ActorCriticPolicy):
	...
	def custom_lstm(self , state_vec , **kwargs):
		...
		#print(obs_states)
		obs_states = tf.transpose(obs_states)
		#print(obs_states)
		obs_states = tf.reshape(obs_states , (-1 , 28 , 3))
		#print(obs_states)
		rnn_layer = RNN(LSTMCell(64))
		#obs_states = tf.expand_dims(obs_states , 0)
		#obs_states = tf.layers.flatten(obs_states)
		#print(obs_states)
		rnn_output = rnn_layer(obs_states)
		#print(rnn_output)
		#print(robot_states)
		robot_states = tf.transpose(robot_states)

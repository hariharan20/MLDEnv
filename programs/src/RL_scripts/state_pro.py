...
def callback(data):
    ...
    goal_dist_pub = rospy.Publisher("Dist_to_Goal/robot1" , Float64 , queue_size =10)
    cluster_pub = rospy.Publisher("Clustered_Obstacles/robot1" , PointCloud2 , queue_size  = 10)
    ...
    least_distance_pub = rospy.Publisher("/Least_distance/robot1" , PointCloud2 , queue_size = 10)
    ...
    pub_nearest_obs = rospy.Publisher("/RL_States/Nearest_Obstacles_States/robot1" , PointCloud2 , queue_size=10)

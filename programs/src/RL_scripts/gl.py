...
class ur(gym.Env):
	def __init__(self):
		...
		#rospy.Subscriber("/robot1/joint_states", JointState, self.cb_js)
		rospy.Subscriber("/robot_as_obstacle/robot1" , PointCloud2 , self.cb_rao)
		rospy.Subscriber("/Dist_to_Goal/robot1" , Float64 , self.cb_dtg)
	...
	def _get_obs(self):
		...
		joint.joint_name = "robot::elbow_joint"
		rospy.wait_for_service('/gazebo/get_joint_properties')
		angle_0 = req(joint)
		angle_0 = angle_0.position[0]
		position.append(float(angle_0))
		joint.joint_name = "robot::shoulder_pan_joint"
		rospy.wait_for_service('/gazebo/get_joint_properties')
		angle_0 = req(joint)
		angle_0 = angle_0.position[0]
		position.append(float(angle_0))
		joint.joint_name = "robot::shoulder_lift_joint"
		rospy.wait_for_service('/gazebo/get_joint_properties')
		angle_0 = req(joint)
		angle_0 = angle_0.position[0]
		position.append(float(angle_0))
		joint.joint_name = "robot::wrist_1_joint"
		rospy.wait_for_service('/gazebo/get_joint_properties')
		angle_0 = req(joint)
		angle_0 = angle_0.position[0]
		position.append(float(angle_0))
		joint.joint_name = "robot::wrist_2_joint"
		rospy.wait_for_service('/gazebo/get_joint_properties')
		angle_0 = req(joint)
		angle_0 = angle_0.position[0]
		position.append(float(angle_0))
		joint.joint_name = "robot::wrist_3_joint"
		rospy.wait_for_service('/gazebo/get_joint_properties')
		angle_0 = req(joint)
		#print(angle_0)
		angle_0 = angle_0.position[0]
